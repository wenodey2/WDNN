...
tab7m = pd.concat([hrs, metrics_per["MAE_s_2"]], axis=1)
tab7m = pd.concat([tab7m, metrics_df_s_2["MAE"]], axis=1)
tab7m = pd.concat([tab7m, metrics_stan_s_2["MAE"]], axis=1)
tab7m = pd.concat([tab7m, metrics_wdnn_s_2["MAE"]], axis=1)

# Table 7 RMSE
tab7r = pd.concat([hrs, metrics_per["RMSE_s_2"]], axis=1)
tab7r = pd.concat([tab7r, metrics_df_s_2["RMSE"]], axis=1)
tab7r = pd.concat([tab7r, metrics_stan_s_2["RMSE"]], axis=1)
tab7r = pd.concat([tab7r, metrics_wdnn_s_2["RMSE"]], axis=1)

tab7m.to_csv('tables/table7.csv')
