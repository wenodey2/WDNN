...
tab6m = pd.concat([hrs, metrics_per["MAE_s_1"]], axis=1)
tab6m = pd.concat([tab6m, metrics_df_s_1["MAE"]], axis=1)
tab6m = pd.concat([tab6m, metrics_stan_s_1["MAE"]], axis=1)
tab6m = pd.concat([tab6m, metrics_wdnn_s_1["MAE"]], axis=1)

# Table 6 RMSE
tab6r = pd.concat([hrs, metrics_per["RMSE_s_1"]], axis=1)
tab6r = pd.concat([tab6r, metrics_df_s_1["RMSE"]], axis=1)
tab6r = pd.concat([tab6r, metrics_stan_s_1["RMSE"]], axis=1)
tab6r = pd.concat([tab6r, metrics_wdnn_s_1["RMSE"]], axis=1)

tab6m.to_csv('tables/table6.csv')
