...
metrics_1 = metrics(1, "power", 36)    # dataset_1
metrics_2 = metrics(1, "power", 160)   # dataset_2

mae_list = [metrics_1[0], metrics_2[0]]
rmse_list = [metrics_1[0], metrics_2[0]]

dataset_df = pd.DataFrame({"Data": ["Dataset-1", "Dataset-2"]})
...
metrics_df.to_csv('tables/table4.csv', index=True)
