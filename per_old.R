...
# Speed Metrics
metrics_per_s_1 = metrics_persistence(data1, seq(2, 250, 7), 18359, 26570, 36, 12)
metrics_per_s_2 = metrics_persistence(data2, seq(2, 960, 6), 15593, 22855, 160, 12)
metrics_per_s_3 = metrics_persistence(data3, seq(2, 300, 3), 43825, 52580, 100, 12)

# Power Metrics
metrics_per_p_1 = metrics_persistence(data1, seq(4, 252, 7), 18359, 26570, 36, 12)
metrics_per_p_2 = metrics_persistence(data2, seq(5, 963, 6), 15593, 22855, 160, 12)
